<script>
    ...
    const enlaces = [
        { nombre: 'Inicio', ruta: '/dashboard', roles: ['ADMIN', 'ENCARGADO', 'VOLUNTARIO'] },
        { nombre: 'Solicitudes', ruta: '/dashboard/administracion/organizaciones', roles: ['ADMIN'] },
        { nombre: 'Recursos', ruta: '/dashboard/administracion/recursos', roles: ['ADMIN'] },
        { nombre: 'Talentos', ruta: '/dashboard/administracion/habilidades', roles: ['ADMIN'] },
        
        { nombre: 'Solicitudes', ruta: '/dashboard/acopio/solicitudes', roles: ['ENCARGADO'] },
        { nombre: 'Inventario', ruta: '/dashboard/acopio/inventario', roles: ['ENCARGADO'] },
        { nombre: 'Personal', ruta: '/dashboard/acopio/personal', roles: ['ENCARGADO'] },
        
        // { nombre: 'Personal', ruta: '/dashboard/refugios/personal', roles: ['ENCARGADO'] },

        // { nombre: 'Personal', ruta: '/dashboard/salud/personal', roles: ['ENCARGADO'] },

        // { nombre: 'Personal', ruta: '/dashboard/transporte/personal', roles: ['ENCARGADO'] },
        // { nombre: 'Vehiculos', ruta: '/dashboard/refugios/Vehiculos', roles: ['ENCARGADO'] },
        // { nombre: 'Viajes', ruta: '/dashboard/refugios/personal', roles: ['ENCARGADO'] },
    ...
    let enlacesFiltrados = $derived(enlaces.filter(enlace => enlace.roles.includes(data.user?.rol)));
</script>
